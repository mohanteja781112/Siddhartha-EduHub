      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center text-center">
        ...
        >
          ...
          <motion.button 
            ...
            whileTap={{ scale: 0.95 }}
            className="w-full sm:w-auto group flex items-center justify-center gap-2 px-8 py-4 bg-gradient-to-r from-edu-navy to-blue-900 text-white font-semibold rounded-full shadow-[0_10px_20px_rgba(7,_42,_64,_0.3)] hover:shadow-[0_15px_30px_rgba(7,_42,_64,_0.4)] transition-all duration-300"
          >
            Admin Login
          ...
          <motion.button 
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            className="w-full sm:w-auto flex items-center justify-center px-8 py-4 glassmorphism text-edu-navy font-semibold rounded-full hover:bg-white/90 border border-edu-navy/20 hover:border-edu-navy/40 transition-all duration-300"
          >
            Student Login
          </motion.button>
        </motion.div>
